...
from data_utils.datasets_general_cf import (
    PairwiseTrnData,
...
class DataHandlerGeneralCF:
    ...
    def load_data(self):
        ...
        if configs["data"]["name"] == "katchers":
            with open(f"{self.predir}tst_maksed_unquery_iids.pkl", "rb") as fs:
                tst_data.masked_unquery_iids = pickle.load(fs)
